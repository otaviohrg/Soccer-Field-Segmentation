...
class UNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.up_convolution_1 = UpSample(576, 288)
        self.up_convolution_2 = UpSample(288, 144)
        self.up_convolution_3 = UpSample(144, 72)
        self.up_convolution_4 = UpSampleFree(72, 16)
