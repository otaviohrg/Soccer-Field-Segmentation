...
class UNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.up_convolution_1 = UpSample(960, 480)
        self.up_convolution_2 = UpSample(480, 240)
        self.up_convolution_3 = UpSample(240, 120)
        self.up_convolution_4 = UpSampleFree(120, 16)
